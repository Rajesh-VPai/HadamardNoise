...
import static TaguchHadamardNoise.MathsContxtLAv0_1_Prod.eatAll;
import static TaguchHadamardNoise.HadamardNoise.ClassicTaguchiAlg;
import static TaguchHadamardNoise.HadamardNoise.LEVELS;
import static TaguchHadamardNoise.HadamardNoise.Length;
import static TaguchHadamardNoise.HadamardNoise.Path;
import static TaguchHadamardNoise.HadamardNoise.ROWSDOE;
import static TaguchHadamardNoise.HadamardNoise.UseFullFactorial;
import static TaguchHadamardNoise.HadamardNoise.UseLevelsFromArray;
import static TaguchHadamardNoise.HadamardNoise.UseLevelsFromFile;
import static TaguchHadamardNoise.TestHarnessDOEDPFine.PassFailTestCase;
 ...
 */
public class UsageDOEDPFine {

    public static Logger log = Logger.getLogger(UsageDOEDPFine.class.getName());
...
//15)	Argument of Functions:L=4: Expr Alone(3 types), Expr with Inner Function
        if((j >= -1)&&(j < 30))
            TestHarnessDOEDPFine.SanityTestCases(AlgoName,j);
        
        
        return j;
    }
    
    public static void mainRegresssionDOEDP(TestHarnessDOEDPFine TestData) {
        ...
        String OverallRegressionStatus = "Pass All (-1 to 10) Except Test Cases: "
                + "\n" + "TestCases:Unit Test Cases" + " All Passing"
                + "\n" + "TestCases:Names " + " All Passing"
                ;
        System.out.print(ConsoleColors.BLUE + "Overall Regression Status" + OverallRegressionStatus + ConsoleColors.RESET);
        ...
        while (j <= EndTestCase) {
            ...
            try {
                    ...
                    System.out.println(ConsoleColors.GREEN +"DOETestCase Row=:"+TestHarnessDOEDPFine.TestCaseRow + ConsoleColors.RESET);
                    
                    String[] args=null;
                    HadamardNoise.pmain(args);
                    System.out.print(System.lineSeparator());
                ...
                ;//Do Nothing : Test Case Passed
                    ...
                    System.out.print(System.lineSeparator());
                    System.out.println(ConsoleColors.GREEN +"DOETestCase Row=:"+TestHarnessDOEDPFine.TestCaseRow + ConsoleColors.RESET);
                    System.out.println(ConsoleColors.GREEN +"System Set InputFile:"+HadamardNoise.ConfigFileName + ConsoleColors.RESET);
                    //HDOEDefine.Myprintf();
