...
import static TaguchHadamardNoise.TestHarnessDOE.PassFailTestCase;
...
//15)	Argument of Functions:L=4: Expr Alone(3 types), Expr with Inner Function
    ...
    public static void mainRegresssionDOE(TestHarnessDOE TestData) {
        ...
        String OverallRegressionStatus = " Hadamard:Pass All (-1 to 30) Except Test Cases: "
                + "\n" + "TestCases:Unit Test Cases" + " All Passing"
                + "\n" + "TestCases:Names " + " All Passing"
                ;
        System.out.print(ConsoleColors.BLUE + " Hadamard Overall Regression Status " + OverallRegressionStatus + ConsoleColors.RESET);
